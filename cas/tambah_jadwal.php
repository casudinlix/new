<?php require_once('../Connections/con.php');
      require_once('../Connections/session.php');?><?php
...
?>
              ...
              <tr> </tr>
              <tr valign="baseline">
                <td align="right"><div align="left"><strong>Stasiun Akhir:</strong></div></td>
...
?>
              ...
              <tr> </tr>
              <tr valign="baseline">
                <td align="right"><div align="left"><strong>Harga Rp:</strong></div></td>
                <td><input type="text" name="Harga" value=""  size="32" /></td>
              </tr>
              <tr valign="baseline">
                <td align="right"><div align="left"><strong>Jam:</strong></div></td>
                <td><input type="time" name="Jam" value="" size="32" /></td>
              </tr>
              <tr valign="baseline">
